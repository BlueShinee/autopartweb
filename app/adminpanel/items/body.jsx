...
export default async function Body() {
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center">
        <Link href={"/adminpanel/items/create"} className="w-[90%] py-2 px-4 flex justify-center items-center text-lg font-semibold text-white bg-green-400 rounded-md hover:bg-green-600 transition-all hover:cursor-pointer">New Item</Link>
...
async function Card(props) {
    return(
        <Link href={`/adminpanel/items/${props.itemid}`} className='flex w-[90%] my-4 border-2 border-gray-400 rounded-lg h-32'>
