    ...
    <div className="w-full h-screen flex justify-center bg-blue-400 items-center">
        <div className="w-[85%] rounded-md bg-white flex flex-col items-center">
            ...
            <form action={createuser} className="w-full flex flex-col items-center">
                ...
                <input type="number" name="number" placeholder="07* *** ****" className="w-[80%] mb-2 border-2 border-gray-400 rounded-md py-1 px-2 focus:outline-blue-400" required maxLength="11"/>

                <label htmlFor="address" className="w-[80%] mb-1 font-medium">Shipping Address:</label>
                <input type="text" name="address" placeholder='YOUR HOME ADRESS' className="w-[80%] border-2 border-gray-400 rounded-md py-1 px-2 focus:outline-blue-400" required/>
