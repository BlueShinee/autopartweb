...
export default async function page({params}) {
  ...
  return (
      <>
          <Header settings={settings} redirectBack={'/cart'} title={"Cart"} isLogged={user?.user !== undefined} profileImage={user?.user.image || "https://cdn-icons-png.flaticon.com/512/3177/3177440.png"} />
