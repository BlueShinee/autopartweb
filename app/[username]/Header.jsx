      ...
      <nav style={styles} className="navbar navbar-expand-custom navbar-mainbg">
        <a className="navbar-brand" href="/">
          <div className="navbar-logo">
            ...
            <div>
              <h2 style={{whiteSpace: 'nowrap', margin: '0px 5px'}}>{user || 'Evelocore Tunnel'}</h2>
            </div>
          </div>
          {/* <div className="navbar-content">
            <h3 id="headerProjectName">{user || 'Evelocore Tunnel'}</h3>
          </div> */}
        </a>
          ...
          <ul className="navbar-nav ml-auto">
            ...
            <li className="nav-item" onClick={(e) => {handleTabClick(e)}}>
              <a className="nav-link active">
                <i className="fas fa-user-alt"></i>Portfolio
              </a>
            </li>
            <li className="nav-item" onClick={(e) => {handleTabClick(e)}}>
            ...
            <li className="nav-item" onClick={(e) => {handleTabClick(e)}}>
              <a className="nav-link">
                <i className="fa fa-chess-queen"></i>Projects
              </a>
            </li>
