...
function SearchForm(props){
    return(
        <form class="w-full max-w-md" action={searching}>
            ...
            <div class="w-full p-4 flex items-center justify-center">
                <input type="text" name="keywords" placeholder="Search Auto Parts..." class="ml-3 w-full px-4 py-2 rounded-full border border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-300 ease-in-out"/>
